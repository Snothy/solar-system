...
function BodyCard({ body }: { body: CelestialBodyData }) {
  ...
  const hasOrbital =
    body.rel_a != null || body.rel_e != null || body.rel_i != null;
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            {body.gm != null && <span>{fmtMass(body.gm)}</span>}
            {body.equatorialRadius != null && (
              <span>r = {fmtRadius(body.equatorialRadius)}</span>
            )}
            {body.meanTemperature != null && (
              <span>{fmtTemp(body.meanTemperature)}</span>
            )}
          </div>
        </div>
          ...
          >
            ...
            <div>
              <ParamGroup title="Physical">
                {body.gm != null && (
                  <Param label="Mass" value={fmtMass(body.gm)} />
                )}
                {body.equatorialRadius != null && (
                  <Param
                    label="Radius"
                    value={fmtRadius(body.equatorialRadius)}
                  />
                )}
                {body.radii != null && (
                  <Param
                    label="Radii (x/y/z)"
                    value={`${(body.radii.x / 1e3).toFixed(0)} / ${(body.radii.y / 1e3).toFixed(0)} / ${(body.radii.z / 1e3).toFixed(0)} km`}
                  />
                )}
                {body.surfaceGravity != null && (
                  <Param
                    label="Surface gravity"
                    value={fmtGravity(body.surfaceGravity)}
                  />
                )}
                {body.meanTemperature != null && (
                  <Param
                    label="Temperature"
                    value={fmtTemp(body.meanTemperature)}
                  />
                )}
                {body.albedo != null && (
                  <Param label="Bond albedo" value={body.albedo.toFixed(3)} />
                )}
                {body.rotationPeriod != null && (
                  <Param
                    label="Rotation period"
                    value={fmtPeriod(body.rotationPeriod)}
                  />
                )}
                {body.axialTilt != null && (
                  <Param label="Axial tilt" value={fmtDeg(body.axialTilt, 2)} />
                )}
            ...
            <div>
              {hasOrbital && (
                <ParamGroup title="Orbital Elements (J2000)">
                  {body.rel_a != null && (
                    <Param label="Semi-major axis" value={fmtAU(body.rel_a)} />
                  )}
                  {body.rel_e != null && (
                    <Param label="Eccentricity" value={body.rel_e.toFixed(6)} />
                  )}
                  {body.rel_i != null && (
                    <Param label="Inclination" value={fmtDeg(body.rel_i, 4)} />
                  )}
                  {body.rel_node != null && (
                    <Param
                      label="Ascending node Ω"
                      value={fmtDeg(body.rel_node, 3)}
                    />
                  )}
                  {body.rel_peri != null && (
                    <Param
                      label="Arg. of periapsis ω"
                      value={fmtDeg(body.rel_peri, 3)}
                    />
                  )}
                  {body.rel_M != null && (
                    <Param
                      label="Mean anomaly M₀"
                      value={fmtDeg(body.rel_M, 3)}
                    />
                  )}
                </ParamGroup>
              )}
              ...
              {hasPole && (
                <ParamGroup title="Pole Orientation">
                  {body.poleRA != null && (
                    <Param label="Pole RA" value={fmtDeg(body.poleRA, 2)} />
                  )}
                  {body.poleDec != null && (
                    <Param label="Pole Dec" value={fmtDeg(body.poleDec, 2)} />
                  )}
                  {body.W0 != null && (
                    <Param
                      label="Prime meridian W₀"
                      value={fmtDeg(body.W0, 3)}
                    />
                  )}
                  {body.Wdot != null && (
                    <Param
                      label="Rotation rate Ẇ"
                      value={`${body.Wdot} °/day`}
                    />
                  )}
                </ParamGroup>
              ...
              {hasHarmonics && (
                <ParamGroup title="Gravity Harmonics">
                  ...
                  {body.c22 != null && (
                    <Param label="C₂₂" value={body.c22.toExponential(3)} />
                  )}
                  {body.s22 != null && (
                    <Param label="S₂₂" value={body.s22.toExponential(3)} />
                  )}
                </ParamGroup>
              )}
            </div>
...
export function BodiesPanel() {
  ...
  const counts = useMemo(() => {
    ...
    for (const cat of CATEGORIES.slice(1)) {
      ...
      out[cat] = ALL_BODIES.filter(
        (b) => b.type && types.includes(b.type),
      ).length;
    }
    return out;
  }, []);
